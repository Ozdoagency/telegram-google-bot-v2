...
const vercelUrl = 'https://telegram-google-bot-git-main-ozdoagencys-projects.vercel.app';
...
// Логирование запросов на /webhook для отладки
...
// Функция для анализа текста через Google AI с дополнительным логированием
